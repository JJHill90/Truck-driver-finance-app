...
function presentHubProfile(account, records) {
  ...
  const fuelVehicles = normalizeFuelVehicles(profile.fuelVehicles);
  const activeVehicle = presentFuelVehicle(activeFuelVehicle(fuelVehicles));
  ...
  return {
    ...
    fuelVehicles: fuelVehicles.map((v) => presentFuelVehicle(v)),
