...
function finalizeVendorGate(ocrResult) {
  ...
  if (!finalVendor || looksLikeJunkVendor(finalVendor)) {
    if (looksLikeJunkVendor(finalVendor)) {
      ocrResult.vendor = "";
      if (ocrResult.entity && looksLikeJunkVendor(ocrResult.entity)) ocrResult.entity = "";
    }
