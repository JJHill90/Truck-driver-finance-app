...
const SITE_NAME_REJECT_RE =
  /\b(rewards?|fleet|card|truck\s*stop|servo|connect|outlet|service|express|pty|ltd|limited|australia|group|retail|holdings?|tax|invoice|receipt|abn|tel|phone|gst|total|debit|credit|eftpos|approved|nab|visa|master|petroleum|select)\b/i;
