...
function summariseOvernightDays(records = {}, profile = {}, financialYear) {
  ...
  return {
    ...
    entries,
    note: `${rates.determination}: overnight / travel allowance days are estimated from payslip Travel/Overnight/LAFHA amounts ÷ the truck-driver meal rate ($${round2(ratePerDay)}/day) for ${rates.incomeYear}, or from an explicit day count saved on the entry. Use this as a planning snapshot of nights claimed versus days in the financial year — confirm with your payslips and tax adviser.`,
  };
}
