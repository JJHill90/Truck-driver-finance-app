...
function summariseLafha(profile = {}, income = [], financialYear) {
  ...
  return {
    ...
    paid,
    note: `${rates.determination} Table 5 — employee truck driver meal reasonable amounts for income year ${rates.incomeYear} when living/travelling away overnight. Meals only (excludes accommodation). Claim actual spend up to this daily amount when a travel / living-away allowance was paid. ATO updates these annually (not Jan/Jul).`,
  };
}
