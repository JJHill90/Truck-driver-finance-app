...
/**
 * If a new deploy left accounts/ledgers empty but a local backup is still
 * on the disk, restore the latest archive so profiles are not wiped.
 */
