...
const CORRIDORS = [
  ...
  },
  {
    ...
    aliases: ["brisbane", "toowoomba", "roma", "charleville", "barcaldine", "longreach", "winton", "cloncurry", "mount isa", "st george", "mitchell"],
    distanceKm: 1820,
  ...
  {
    id: "capricorn",
    name: "Capricorn Highway (A4)",
    aliases: ["longreach", "barcaldine", "alpha", "emerald", "duaringa", "gracemere", "rockhampton"],
    distanceKm: 670,
    nhvrNetworks: ["general", "b_double", "road_train_t1"],
    blockedNetworks: ["road_train_t2"],
    westPremium: true,
    heading: "east",
    regions: [
      { fromKm: 0, toKm: 120, band: "outback_west" },
      { fromKm: 120, toKm: 400, band: "remote" },
      { fromKm: 400, toKm: 670, band: "regional" },
    ],
  },
];
