...
const STATIONS = [
  ...
  { id: "bp-stgeorge", name: "BP St George", retailerId: "bp", corridorId: "warrego", km: 540, lat: -28.037, lng: 148.58, band: "remote", capital: "brisbane", truckAccess: true, bDouble: true, roadTrain: true, amenities: ["food", "parking"], biasCpl: 3 },
  { id: "shell-barcaldine", name: "Shell Barcaldine", retailerId: "shell", corridorId: "capricorn", km: 107, lat: -23.553, lng: 145.289, band: "remote", capital: "brisbane", truckAccess: true, bDouble: true, roadTrain: true, amenities: ["food", "parking", "shower"], biasCpl: 3 },
  { id: "ampol-emerald", name: "Ampol Emerald", retailerId: "ampol", corridorId: "capricorn", km: 390, lat: -23.525, lng: 148.162, band: "regional", capital: "brisbane", truckAccess: true, bDouble: true, roadTrain: true, amenities: ["food", "parking"], biasCpl: 1 },
  { id: "bp-gracemere", name: "BP Gracemere", retailerId: "bp", corridorId: "capricorn", km: 655, lat: -23.437, lng: 150.456, band: "regional", capital: "brisbane", truckAccess: true, bDouble: true, roadTrain: false, amenities: ["food", "parking"], biasCpl: 0 },
