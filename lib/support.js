...
function messagesFile() {
  return path.join(dataDir(), "support-messages.json");
}
...
function saveMessages(list) {
  ...
  writeJsonAtomic(messagesFile(), { messages: list });
}
 ...
 */
function saveContactMessage({ name, email, phone, message, username, priority }) {
  const entry = {
...
function mailtoHref({ name, email, phone, message, priority }) {
