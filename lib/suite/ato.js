...
function mealCapsForYear(fy, annualSalary) {
  ...
  const daily = (travel.domesticTravelDaily && travel.domesticTravelDaily[band]) || travel.domesticTravelDaily.band1;
  return {
    determination: travel.determination,
    overtimeMealCap: travel.overtimeMealCap,
    salaryBand: band,
    domesticTravelDaily: daily,
    breakfast: daily.breakfast,
    lunch: daily.lunch,
    dinner: daily.dinner,
    mealsDaily: Math.round((daily.breakfast + daily.lunch + daily.dinner) * 100) / 100,
  };
}
