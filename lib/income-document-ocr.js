...
function buildIncomeSummaryFromText(text, purpose = "income") {
  ...
  const netPay =
    labeledAmount(text, ["net\\s*pay", "net\\s*amount", "take\\s*home", "net\\s*wages", "net"]) ||
    null;
  ...
  return {
    ...
    vendorAbn: "",
    date: null,
    amount: netPay || grossTotal || money.amount,
    grossTotal: grossTotal || money.amount,
    taxableIncome: taxableIncome || grossTotal || money.amount,
    gst: gstAmount || null,
